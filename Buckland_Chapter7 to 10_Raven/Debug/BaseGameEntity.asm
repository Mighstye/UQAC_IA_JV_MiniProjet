; Listing generated by Microsoft (R) Optimizing Compiler Version 19.14.26431.0 
	...
	TITLE	D:\IA jeux vidéo\Projets\UQAC_IA_JV_MiniProjet\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG158156 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG158157 DB	'd', 00H, ':', 00H, '\', 00H, 'i', 00H, 'a', 00H, ' ', 00H
	...
	DB	00H
	ORG $+4
$SG158158 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\ia jeux vidéo\projets\uqac_ia_jv_miniprojet\common\game\basegameentity.cpp
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG158156
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG158157
	push	OFFSET $SG158158
	call	__wassert
