; Listing generated by Microsoft (R) Optimizing Compiler Version 19.14.26431.0 
	...
	TITLE	D:\IA jeux vidéo\Projets\UQAC_IA_JV_MiniProjet\Buckland_Chapter7 to 10_Raven\Raven_TargetingSystem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 1127 : 	{	// propagate on container move assignment
...
; 1138 : 	{	// (maybe) propagate on container move assignment
...
; 1093 : 	{	// test for allocator inequality
...
; 925  : 		if (this != _STD addressof(_Right))
...
; 926  : 			{	// different, assign it
; 927  : 			clear();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?clear@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAEXXZ ; std::list<Raven_Bot *,std::allocator<Raven_Bot *> >::clear

; 928  : 			this->_Move_alloc(_Right._Getal());
...
; 929  : 			_Assign_rv(_STD move(_Right), bool_constant<_Always_equal_after_move<_Alnode>>());
...
; 631  : 		const bool _Reload = _Alnode_traits::propagate_on_container_move_assignment::value
; 632  : 			&& _Getal() != _Al;
...
; 162  :   bool          isAlive()const{return m_Status == alive;}
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\ia jeux vidéo\projets\uqac_ia_jv_miniprojet\buckland_chapter7 to 10_raven\raven_targetingsystem.cpp
